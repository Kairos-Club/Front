...
/**
 * Modified by Partikule
 * line 195 : comment of dom.time update
 */
...
(function(window) {
  ...
  utils = {
    ...
    position: (function() {
		...
		/**
         * Modified by Partikule
         * The old one returned bullshit in Chrome / Safari
		 * @param o
		 * @returns {number}
		 */
		function getOffX(o) {
		  ...
		  while (o) {
			  curleft += (o.offsetLeft - o.scrollLeft + o.clientLeft);
			  o = o.offsetParent;
		  }
      ...
      function getOffY(o) {
		  ...
		  while (o) {
			  curtop += (o.offsetTop - o.scrollTop + o.clientTop);
			  o = o.offsetParent;
		  }
